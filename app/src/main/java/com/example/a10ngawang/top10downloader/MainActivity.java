...
//
//             ArrayAdapter<FeedEntry> arrayAdapter = new ArrayAdapter<>(MainActivity.this, R.layout.list_item, parseApplication.getApplication());
//            listApps.setAdapter(arrayAdapter);
            FeedAdapter feedAdapter = new FeedAdapter(MainActivity.this,R.layout.list_record,parseApplication.getApplication());
        ...
        private String downloadXML(String urlPath){
            ...
            try{
             ...
             //   BufferedReader reader = new BufferedReader(inputStreamReader);
                ...
                Log.e(TAG, "downloadXML: IO Exception read data: " + e.getMessage());
